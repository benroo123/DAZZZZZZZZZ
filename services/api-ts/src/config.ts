...
export const config = {
  ...
  databaseUrl: process.env.DATABASE_URL ?? 'postgresql://dachang:dachang@127.0.0.1:55432/dachang',
  redisUrl: process.env.REDIS_URL ?? 'redis://127.0.0.1:56379/0',
  rabbitmqUrl: process.env.RABBITMQ_URL ?? 'amqp://dachang:dachang@127.0.0.1:5673',
  s3: {
    endPoint: process.env.S3_ENDPOINT ?? '127.0.0.1',
    port: integer('S3_PORT', 59000),
